...
Use JS Service Worker.

# DEMO

* [DEMO](https://ytyaru.github.io/JS.ServiceWorker.20210113144638/)
...
1. Start the terminal
    1. Move the current directory. To the path where index.html is. `cd JS.ServiceWorker.20210113144638 / src`
